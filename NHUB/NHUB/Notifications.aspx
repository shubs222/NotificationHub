...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <script lang="javascript">
        ...
        <div class="auto-style1" style="height: 699px; z-index: 1; width: 934px; position: relative; top: 2px; left: -5px; text-align: right;">
            ...
            <div  style="width: 771px; height: 134px; position: relative; left: -237px; top: 3px; z-index: 1; margin-left: 240px; margin-top: 0px" class="text-left"> 
       ...
       <asp:Button ID="AddNotificationButton" runat="server" style="width: 125px; height: 49px" Text="Add Notification" OnClick="AddNotificationButton_Click" />
    </div>
</asp:Content>