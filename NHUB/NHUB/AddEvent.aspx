...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div class="text-center" style="height: 544px; position: relative; left: 2px; top: 9px; width: 921px; z-index: 1">
            ...
            <div class="text-center" style="height: 276px">
                <table class="nav-justified" style="height: 276px">
                    ...
                    <tr>
                        ...
                        <td class="text-left" style="height: 39px">
                            <asp:RequiredFieldValidator ID="NameValidator" runat="server" ControlToValidate="NameTextBox" EnableViewState="False" ErrorMessage="Enter Name" ForeColor="Red" OnDataBinding="AddButton_Click1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                ...
                <table align="center" class="nav-justified">
                    <tr>
                        <td style="width: 366px">Dynamic Fields:</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 366px; height: 20px;"></td>
